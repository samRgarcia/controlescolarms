    ...
    return (
        <Formik
            ...
            validationSchema={Yup.object({
                ...
                localidadDeNacimiento:Yup.number().required('Localidad requerido'),
            ...
            <Form>
                <LayoutForm>
                    <div className={'item-nom box-width'}>
                        ...
                        <TextFields label={"Segundo apellido*"} name={"segundoApellido"} type={"text"} placeholder=".."/>
                    </div>
                    ...
                    <div className={'box-width'}>
                        ...
                        <SelecEstados label={'Estado de nacimiento*'} name={'estadoNacimiento'}/>
                    </div>
                    <div className={'box-width'}>
                        <SelecMunicipio label={'Municipio de nacimiento*'} name={'municipioNacimiento'}/>
                        <SelecLocalidad label={'Localidad de nacimiento*'} name={'localidadDeNacimiento'}/>
                    </div>
                    <div className={'box-width'}>
